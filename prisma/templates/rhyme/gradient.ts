...
export const gradientRhyme = {
  name: 'Gradient Rhyme Time',
  quizType: QuizType.RHYME_TIME,
  html: `
  ...
  `,
  variables: {
    title: "Rhymes in Flow",
    subtitle: "Find the rhyming words in this colorful journey",
    rhymeGrid: "",
    brandingText: "Flow with Words"
  },
}; 