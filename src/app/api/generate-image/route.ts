        ...
        <head>
          ...
          <style>
            ...
            * {
            ...
            @font-face {
              font-family: 'Rooftop';
              src: url('${path.join(process.cwd(), 'public', 'fonts', 'Rooftop-Regular.otf')}') format('opentype');
              font-weight: 400;
              font-style: normal;
            }
            ...
            @font-face {
              font-family: 'Rooftop';
              src: url('${path.join(process.cwd(), 'public', 'fonts', 'Rooftop-Bold.otf')}') format('opentype');
              font-weight: 700;
              font-style: normal;
            }
